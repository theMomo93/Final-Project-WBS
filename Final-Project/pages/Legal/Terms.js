  ...
  return (
    <div className="bg-gray-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
      <div className="container mx-auto max-w-3xl">
        ...
        <h2 className="text-lg sm:text-xl font-bold mb-4">Acceptance of Terms</h2>
        ...
        <h2 className="text-lg sm:text-xl font-bold mb-4">User Responsibilities</h2>
        ...
        <h2 className="text-lg sm:text-xl font-bold mb-4">Platform Usage</h2>
        ...
        <h2 className="text-lg sm:text-xl font-bold mb-4">Community Guidelines</h2>
        ...
        <h2 className="text-lg sm:text-xl font-bold mb-4">Changes to Terms</h2>
