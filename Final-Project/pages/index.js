    ...
    <div>
      <div className="bg-white min-h-screen flex flex-col">
        ...
        <main className="flex-1">
          ...
          <section class="flex items-center lg:h-screen font-poppins dark:bg-white-100">
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="flex flex-wrap justify-center -mx-3 pt-11 ">
                <div class="w-full px-3 mb-6 lg:px-2 md:w-1/2 lg:w-1/3 ">
                <div class="p-5 bg-white rounded-b shadow-3xl transition ease-in-out delay-100  hover:-translate-y-1 hover:scale-110 hover:bg-amber-50 duration-300  ">
                        
                        <h2 class="my-3 text-2xl font-bold text-black">Health Insurance</h2>
                        <p class="mb-3 leading-loose text-gray-800 ">Lorem ipsum dor amet oides
                            ispisciousas amet
                        </p>
                        <a href="#"
                            class="inline-flex items-center text-lg font-semibold text-amber-600 text-black hover:text-blue-600">
                            Learn more
