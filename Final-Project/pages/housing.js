            ...
            <ul className="list-disc ml-6 text-lg">
              ...
              <li className="mb-6 font-bold">
                ...
                <p className="text-gray-900 font-medium font-normal">
                  ...
                  apartments as well as furniture, jobs and other gadgets can be
                  found on{" "}
                  <a
                    className="text-amber-400"
                  ...
                  In your local area you can alway look for "walk in" companies
                  that will provide you with some choice of affordable places,
                  and keep you informed if something pops up.
                </p>
              </li>
              <li className="mb-6 font-bold">
                Financial Support
                <p className="text-gray-900 font-medium font-normal">
                  For people with low income will also find a solution to their
                  problems with german Government and laws. People without an
                  income can find solution with{" "}
                  <a
                    className="text-amber-400"
                  ...
                  and apply for arbeitslosengeld. Social housing is also one of
                  the opportunities that families with low income can rely on.
                  Those are payed by the state depending on you status. Housing
                  benefit such as{" "}
                  <a
                    className="text-amber-400"
                  ...
                  is also provided for individuals or families with low income.
                </p>
              </li>
            </ul>
          </div>
