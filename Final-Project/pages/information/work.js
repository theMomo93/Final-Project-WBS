              ...
              <ul className="list-disc ml-6 text-lg">
                <li className="mb-6 font-bold ">
                  ...
                  <p className="text-gray-900 font-medium font-normal">
                    ...
                    training need to be secured early on as you need to get
                ...
                <li className="mb-6 font-bold">
                  Internships
                  <p className="text-gray-900 font-medium font-normal">
                    All the essentials information about Internships you will
                    find on a website{" "}
                    <a
                    ...
                    for that internship. If you're still in the process of
