      ...
      <div className="flex">
        <div className="w-2/3 p-12">
          ...
          <p className=" indent-4 text-lg">
            ...
            status or immigration status. Virtually anyone can receive emergency
            treatment or simple doctor visit to receive medications. The most of
            the costs for the treatment are covered by your healthcare provider.{" "}
          </p>
          <p className="mb-2 indent-4 text-lg">
            {" "}
            Not only physical health is valued in Germany. Mental illnesses also
            plays an important role in life and they are treated like so. They
            are also treated by the Doctors who often refer person further for
            ...
            <ul className="list-disc ml-6 text-lg">
              <li className="mb-6 font-bold ">
                ...
                <p className="text-gray-900 font-medium font-normal">
                  ...
                  recommended to visit your Doctor for general checkup at least
                  once a year including dentist, vaccinations and other
              ...
              <li className="mb-6 font-bold">
                ...
                <p className="text-gray-900 font-medium font-normal">
                  ...
                  health insurance. Regardless of insurance company you will be
                  issued a healthcare card, that will have you adress, name and
                  healthcare provider insurance number saved on the card. The
                  card is used at the Doctors and Hospitals as a proof of
                  insurance. <br />
                </p>
              </li>
              <li className="mb-6 font-bold">
                ...
                <p className="text-gray-900 font-medium font-normal">
                  ...
                  mental health means coping well in times of stress and crisis.
                    Issues like sleep disorders and anxiety are
                  normal reactions to having too much on your plate.
                   It is important to remember reaching for help is not a weakness 
                   but strength. Support from doctors and counseling
                  services is available, especially for those dealing
                  with traumatic experiences or adjusting to life in a new
                  country. Professional assistance can provide the needed
                  guidance and courage for a positive future.
                </p>
              </li>
            </ul>
          </div>
